...
%% CreateModel
        function CreateModel(self)
            ...
            link(3) = Link('d',0.34,'a',0,'alpha',pi/2,'qlim',deg2rad([-60 60]), 'offset',0);
            link(4) = Link('d',0,'a',0,'alpha',-pi/2,'qlim',deg2rad([-90 180]), 'offset',0);
            link(5) = Link('d',0.4,'a',0,'alpha',pi/2,'qlim',deg2rad([-30 30]), 'offset',0);
            link(6) = Link('d',0,'a',0,'alpha',-pi/2,'qlim',deg2rad([0 150]), 'offset',0);
            ...
            link(9) = Link('d',0.11,'a',0,'alpha',0,'qlim',deg2rad([45 270]), 'offset',0);
            ...
            link(1).qlim = [-0.75 -0.01];
            link(2).qlim = deg2rad([0 0.1]);
            link(2).offset = pi/2;
